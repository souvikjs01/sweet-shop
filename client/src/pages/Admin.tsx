...
//   const handleUpdateSubmit = (sweet: Sweet) => {
    // e.preventDefault()
    // console.log(formState.name, formState.category, formState.price, formState.quantity);
...
//   }
  ...
  return (
    <main className="container mx-auto p-4">
      ...
      {/* <section className="mb-8 bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-2xl font-semibold text-foreground mb-4">Edit Sweet</h2>
              ...
              {sweets.map((sweet) => (
                <tr key={sweet.id} className="hover:bg-gray-50">
                  ...
                  <td className="py-2 px-4 border-b">
                    <button onClick={handleOpenPopup} className="text-accent hover:underline mr-4">
                      Edit
                    </button>
                    {isPopupOpen && <PopupCard onClose={handleClosePopup} onSubmit={handleEditClick} />}
